...
<body>
	...
	<div class="centerblock">
		<s:form action="registerSubmit">
			...
			<s:textfield label="生日" type="date" name="acc.birthday"></s:textfield>
			<s:textfield label="email" name="acc.email" />
			<s:textfield label="phone" name="acc.phone"/>
			<s:select label="类型" list="#{1:'学生',2:'老师',3:'校长'}" name="acc.acctype"/>
			<s:radio label="性别" list="#{1:'男',2:'女'}" name="acc.sex"/>	
			<s:submit value="注册" />
		</s:form>
	</div>
</body>
